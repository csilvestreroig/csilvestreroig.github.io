---
title: "Silvestre_Roig_et_al. scRNA"
output:
  html_document:
    df_print: paged
---
...
## 6) Antibiotic (Abx / No Abx)
# No Abx: HTO 1,2,5,6
# Abx:    HTO 3,4,7,8

sce$Treatment_02 <- dplyr::case_when(
  hto_lab %in% c("1","2","5","6") ~ "No_treatment_02",
  hto_lab %in% c("3","4","7","8") ~ "Treatment_02",
  TRUE                            ~ NA_character_
)

sce$Antibiotic <- factor(sce$Treatment_02, levels = c("No_treatment_02", "Treatment_02"))
```
...
sce_neutro_corrected$Antibiotic <- sce_neutro$Antibiotic   # or Treatment_02 if renamed
