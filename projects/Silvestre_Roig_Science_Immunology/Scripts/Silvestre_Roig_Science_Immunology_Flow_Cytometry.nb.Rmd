---
title: "Silvestre_Roig_et_al. Science_Immunology_Flow_cytometry_Mass_Cytometry"
...
#Loading data
```{r}
All <- list.files(path="~/Dropbox/Backup Work/Project_Neutrophil_Subsets/EXPERIMENTS/NS-168_Activation_different_models/NSA_009 _ CPM-AMD,LPS part_Neutro mix/ggCyto", pattern=".fcs$")

All <- flowCore::read.flowSet(All, path="~/Dropbox/Backup Work/Project_Neutrophil_Subsets/EXPERIMENTS/NS-168_Activation_different_models/NSA_009 _ CPM-AMD,LPS part_Neutro mix/ggCyto", ignore.text.offset = TRUE)
```
...
ggplot(data_to_plot, aes(x=PHATE_1_PC93, y=PHATE_2_PC93, color=Cell_type)) +
  ...
  scale_color_manual(values=c("Progenitor"= 'lightgray',"immNEU"='palegreen4',"matNEU1"= 'brown4',"matNEU2"= "brown4"))+
 theme_classic()+
